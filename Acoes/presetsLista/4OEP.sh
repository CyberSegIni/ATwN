...
then
	./Acoes/presetsLista/4OEP/1sondaPorta.sh
elif [ $tipoListaInt -eq 2 ]
then
    ./Acoes/presetsLista/4OEP/2sondaPortas1-100.sh
elif [ $tipoListaInt -eq 3 ]
then
    ./Acoes/presetsLista/4OEP/3sondaDiferentePortas.sh
elif [ $tipoListaInt -eq 4 ]
then
    ./Acoes/presetsLista/4OEP/4sondaTodasPortas.sh
elif [ $tipoListaInt -eq 5 ]
then
    ./Acoes/presetsLista/4OEP/5sondaPortasProtocolo.sh
elif [ $tipoListaInt -eq 6 ]
then
    ./Acoes/presetsLista/4OEP/6sondaRapida.sh
elif [ $tipoListaInt -eq 7 ]
then
    ./Acoes/presetsLista/4OEP/7sondaPortasNome.sh
elif [ $tipoListaInt -eq 8 ]
then
    ./Acoes/presetsLista/4OEP/8sondaPortaSequencia.sh
else
